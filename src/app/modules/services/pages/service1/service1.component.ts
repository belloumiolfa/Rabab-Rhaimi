...
@Component({
  ...
  imports: [FrameComponent, CurtainComponent, MenuComponent, ScrollbarComponent, PreloaderComponent, CursorComponent, FooterComponent, HiddenElementsComponent, BannerComponent, CallToAction1Component, ServiceeComponent],
