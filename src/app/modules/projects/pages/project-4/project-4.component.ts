...
@Component({
  ...
  imports: [FooterComponent, HiddenElementsComponent, CursorComponent, PreloaderComponent, ScrollbarComponent, MenuComponent, CurtainComponent, FrameComponent, Bannerp4Component, ProjectP4Component, CallToActionP4Component],
