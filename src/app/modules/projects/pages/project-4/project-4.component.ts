...
@Component({
  ...
  imports: [FooterComponent, HiddenElementsComponent, CursorComponent, ScrollbarComponent, MenuComponent, CurtainComponent, Bannerp4Component, ProjectP4Component, CallToActionP4Component],
